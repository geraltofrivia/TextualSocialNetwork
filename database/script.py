...
database.insert_new_post('hor','110','Hey Jude')
database.insert_new_post('hor','111','Dont make it bad')
database.insert_new_post('hor','112','Take a sad song')
database.insert_new_post('hor','113','And make it better')
